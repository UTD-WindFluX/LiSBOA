...
%01/11/2021 (v 1.1): minor manual changes
%03/16/2021: legend fix
...
vec_sigma=[1/4 1/6 1/8 1/17];%smoothing paramters tested; use [1/4 1/6 1/8 1/17] for 3D calculations; use [1/3 1/4 1/6 1/13] for 2D calculations; 
...
i=inputdlg('Input optimal elevation-angle resolution, then manually select optimal configuration and press Enter.');
